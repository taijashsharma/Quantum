...
const features = [
  ...
  },
  {
    ...
    description:
      "SSO, SCIM provisioning, and advanced access controls.",
  },
  {
    icon: Zap,
    title: "AI-Powered Learning",
    description:
      "Personalized paths and intelligent skill assessments.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-10">
              Everything you need to upskill your workforce and stay ahead in the
